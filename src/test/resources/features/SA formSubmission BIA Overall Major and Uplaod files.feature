@Test3914
Feature: Login to Application and Submit SA Form with BIA rating as MAjor and complete the form submission and upload additiaonl documents via Edit form

  Background: Login to SA Application
    Given I login "BusinessUser"to SA

  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission and uplaod additioanl documents via Edit form
    ...
    Examples: 
      ...
      | Major          | Secret              | Test_05 | Change to   | Unassigned | No NDA required | Project  | Database         | External dev | Internal cloud | Is accessible externally | Other    | Third party admin | external cloud systems | Customers    | PIA has been completed | RIA has been completed | SIA has been completed | No email |
