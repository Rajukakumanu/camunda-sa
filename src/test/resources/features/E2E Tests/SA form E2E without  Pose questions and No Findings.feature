@Test3937
Feature: Login to application and run E2E journey without Pose questions and No Findings
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Examples: 
      ...
      | Major          | Secret              | Test_24 | Unassigned | New system  | No NDA required | Project  | Off the shelf    | Internal development teams | Internal hosting | Is accessible externally | EMEA     | RBS central | internal systems | Internal users | PIA not available | RIA not available | No Email |

  Scenario Outline: As a Manager and Analyst and run E2E journey without Pose questions and No Findings
    ...
    Examples: 
      | Analyst       | manager       |    Status   |
      | Raju Kakumanu | Raju Kakumanu |   Complete |
