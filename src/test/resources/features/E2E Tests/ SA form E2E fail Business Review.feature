@Test3930
Feature: Login to application and run E2E journey for Business fail review
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Examples: 
      ...
      | Major          | Secret              | Test_17 | Unassigned | New system  | No NDA required | Project  | Off the shelf    | Internal development teams | Internal hosting | Is accessible externally | EMEA     | RBS central | internal systems | Internal users | PIA not available | RIA not available | No Email |

  Scenario Outline: As a analyst complete Business fail review
    ...
    Examples: 
      | Analyst       | manager       | review     | Status   |
      | Raju Kakumanu | Raju Kakumanu | inProgress | Scoping |
