@Test3933
Feature: Login to application and run E2E journey for Findings Mitigated
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Examples: 
      ...
      | Major          | Secret              | Test_20 | Unassigned | New system  | No NDA required | Project  | Off the shelf    | Internal development teams | Internal hosting | Is accessible externally | EMEA     | RBS central | internal systems | Internal users | PIA not available | RIA not available | No Email |

  Scenario Outline: As a Manager and Analyst complete the request via Findings mitigated
    ...
    Examples: 
      ...
      | Raju Kakumanu | Raju Kakumanu | Yes        | inProgress | Complete | 
