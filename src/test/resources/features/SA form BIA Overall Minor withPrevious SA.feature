@Test3912
Feature: Login to Application and Submit SA Form with BIA rating as Minor with previous SA selected and complete the form submission

  Background: Login to SA Application
    Given I login "BusinessUser"to SA

  Scenario Outline: Submit a form with BIA overall rating as Minor with project as Previous SA and complete the form submission
    ...
    When I enter details about "<PrevSA>"
    ...
    Examples: 
      | Overall Rating | data classification | PrevSA  | Status                 | New Project |
      | Minor          | Internal            | Test_03 | Complete, not required | Change to   |
