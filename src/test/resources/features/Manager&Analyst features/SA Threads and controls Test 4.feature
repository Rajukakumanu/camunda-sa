...
Feature: Login to Application and Submit SA Form with BIA rating as MAjor and complete the form submission
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Examples: 
      ...
      | Major          | Public              | Test_14 | Unassigned | New system  | No NDA required | Project  | Off the shelf    | External dev | Internal cloud | Is accessible externally | EMEA     | Third party admin | internal systems | Internal users | PIA has been completed | RIA not available | Sends and/or receives | SIA has been completed |
