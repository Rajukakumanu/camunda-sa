...
Feature: Login to Application and Submit SA Form with BIA rating as Major and complete the form submission
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Then I select "<RBS dev teams>" RBS teams develop
    Then I click Next button
    ...
    Examples: 
      ...
      | Major          | Secret              | Test_16 | Unassigned | New system  | No NDA required | Project  | Database         | External dev | Internal cloud | Is accessible externally | EMEA     | RBS Internal | external cloud systems | Customers    | PIA has been completed | RIA not available | Sends and/or receives | SIA has been completed |
