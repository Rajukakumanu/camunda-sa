@Test3921
Feature: Login to Application and Submit SA Form  and as a analyst  Add and Delete threats
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Examples: 
      ...
      | Major          | Internal            | Test_09 | Unassigned | New system  | No NDA required | Project  | Database         | Internal development teams | Internal hosting | Not accessible externally | EMEA     | RBS central | internal systems | Internal users | PIA has been completed | RIA not available | No email |
