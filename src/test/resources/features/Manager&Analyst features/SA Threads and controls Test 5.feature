...
Feature: Login to Application and Submit SA Form with BIA rating as MAjor and complete the form submission
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Examples: 
      ...
      | Major          | Confidential        | Test_15 | Unassigned | New system  | No NDA required | Project  | Off the shelf    | External dev | External cloud | Is accessible externally | EMEA     | RBS Internal | external cloud systems | Customers    | PIA has been completed | RIA not available | Sends and/or receives | SIA has been completed |
