...
Feature: Login to Application and Submit SA Form with BIA rating as MAjor and complete the form submission
  ...
  Scenario Outline: Submit a form with BIA overall rating as Major and complete the form submission
    ...
    Examples: 
      ...
      | Major          | internal            | Test_13 | Unassigned | New system  | No NDA required | Project  | Database         | Internal development teams | External cloud | Is accessible externally | EMEA     | Third party admin | external cloud systems | Third party suppliers | PIA has been completed | RIA not available | No email | SIA has been completed |
